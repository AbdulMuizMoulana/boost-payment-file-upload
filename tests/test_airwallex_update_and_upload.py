...
test_data = [
    {"url": DEV_URL, "username": DEV_USERNAME, "password": DEV_PASSWORD},
    {"url": UAT_URL, "username": UAT_USERNAME, "password": UAT_PASSWORD},
]


@pytest.mark.parametrize("t_data", test_data)
def test_airwallex_gateway_update_dev_uat(setup, t_data):
    driver = setup
